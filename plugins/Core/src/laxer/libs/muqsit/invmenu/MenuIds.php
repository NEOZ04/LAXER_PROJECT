...
namespace laxer\libs\muqsit\invmenu;

use laxer\libs\muqsit\invmenu\inventories\ChestInventory;
use laxer\libs\muqsit\invmenu\inventories\DoubleChestInventory;
use laxer\libs\muqsit\invmenu\inventories\HopperInventory;
