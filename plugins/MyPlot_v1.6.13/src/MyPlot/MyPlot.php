...
use MyPlot\provider\CoreMoneyProvider;
...
class MyPlot extends PluginBase
{
	...
	public function onEnable() : void {
		...
		if($this->getConfig()->get("UseEconomy", false) === true) {
			...
			elseif(($plugin = $this->getServer()->getPluginManager()->getPlugin("Core")) !== null) {
				if($plugin instanceof Core) {
					$this->economyProvider = new CoreMoneyProvider($plugin);
					$this->getLogger()->debug("Eco set to Core Money");
				}else
				$this->getLogger()->debug("Eco not instance of Core Money");
			}
